    ...
    (function (scene) {
        var LoadingSkin = (function (_super) {
            ...
            __egretProto__.lbl_prog_i = function () {
                ...
                this.lbl_prog = t;
                this.__s(t, ["fontFamily", "height", "size", "text", "textAlign", "verticalAlign", "width", "x", "y"], ["微软雅黑", 40, 24, "0%", "center", "middle", 400, 200, 220]);
                return t;
            };
            __egretProto__.bar_i = function () {
                var t = new egret.gui.UIAsset();
                this.bar = t;
                this.__s(t, ["fillMode", "height", "scale9Grid", "source", "width", "x", "y"], ["repeat", 40, egret.gui.getScale9Grid("4,4,24,24"), "loading_bar", 400, 200, 220]);
                return t;
            };
